...
export class GameData {
   ...
   */
  constructor(gold: number, attack: number, bossHealth: number, currentImage: number) {
    this.gold = gold;
    this.attack = attack;
...
export function LoadGameDataFromStorage(): GameData {
  ...
  if (dataFound) {
    ...
    return new GameData(gameData.gold, gameData.attack, gameData.bossHealth, gameData.currentImage);
  }
  else {
 ...
 */
export function setEnemyHealthFromLocalStorage(setEnemyHealth: React.Dispatch<React.SetStateAction<number>>) {
 ...
 */
export function setGoldFromStorage(setCurrentGoldAmount: React.Dispatch<React.SetStateAction<number>>) {
 ...
 */
export function setImageFromStorage(setCurrentImage: React.Dispatch<React.SetStateAction<number>>) {
